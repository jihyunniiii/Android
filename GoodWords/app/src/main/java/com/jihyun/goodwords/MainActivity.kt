...
import com.jihyun.goodwords.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        sentenceList.add("두 개의 화살을 갖지 마라. 두 번째 화살이 있기 때문에 첫 번쨰 화살에 집중하지 않게 된다.")
        sentenceList.add("그 사람 입자에 서기 전까지 절대 그 사람을 욕하거나 책망하지 마라.")
